<template>
    <input-field
        ...
        @getContent="(content) => this.$emit('getContent', content)"
    >
        <!-- <span class="relative r-2" @click="showPassword"> -->
            <svg @click="showPassword" class="cursor-pointer inline relative bottom-0.5 right-7" xmlns="http://www.w3.org/2000/svg" height="16" width="18" viewBox="0 0 576 512">
                <path d="M288 32c-80.8 0-145.5 36.8-192.6 80.6C48.6 156 17.3 208 2.5 243.7c-3.3 
                ...
                51.2 66.4 81.6 117.6 67.9s81.6-66.4 67.9-117.6c-11.1-41.5-47.8-69.4-88.6-71.1c-5.8-.2-9.2 6.1-7.4 
...
<script>
    ...
    export default {
        ...
        watch: {
            isShow(newValue) {
                console.log( (newValue) ? 'password is visible' : 'password is not visible' )
            }
        }
    }
</script>
